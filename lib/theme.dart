...
Color dimTextColor(BuildContext context, [double opacity = 0.5]) => Theme.of(
  context,
).textTheme.bodyMedium!.color!.withAlpha((255 * opacity).toInt());
...
final ThemeData appTheme =
    ThemeData.from(
      ...
      colorScheme: ColorScheme.fromSwatch(
        primarySwatch: const MaterialColor(0xFFFCB328, <int, Color>{
          50: Color(0xFFFFF6E5),
